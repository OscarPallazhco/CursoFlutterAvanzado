...
//
//     final infoCoordsResponse = infoCoordsResponseFromJson(jsonString);

import 'dart:convert';

InfoCoordsResponse infoCoordsResponseFromJson(String str) => InfoCoordsResponse.fromJson(json.decode(str));

String infoCoordsResponseToJson(InfoCoordsResponse data) => json.encode(data.toJson());

class InfoCoordsResponse {
    InfoCoordsResponse({
        this.type,
        this.query,
        this.features,
    ...
    factory InfoCoordsResponse.fromJson(Map<String, dynamic> json) => InfoCoordsResponse(
        type: json["type"],
